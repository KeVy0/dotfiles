...
alias pdf="zathura"
alias tomybox="python ~/.weechat/python/pyrnotify.py 1337 & ssh -R 1337:localhost:1337 root@46.101.210.67"
alias poke="~/.i3/poke"
...
alias open="xdg-open"
alias gitcreaterepo="curl -u 'KevinDylla' https://api.github.com/user/repos -d '{"name":"$1"}'"
alias ktk="cd ~/Programming/Web/kevindylla_tk/html/"
alias vim="nvim"
alias v="nvim"
...
alias wetter="curl 'http://wttr.in/Garbenteich?lang=de'"
